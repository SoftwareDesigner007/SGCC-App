...
class CategoryModal extends StatelessWidget {
  ...
  const CategoryModal({super.key, required this.category});
      ...
      builder: (_, ctrl) {
        return Container(
          decoration: BoxDecoration(
            ...
            border: Border(
              top: BorderSide(color: category.accentColor.withOpacity(0.4), width: 1.5),
            ),
            boxShadow: [
              BoxShadow(
            ...
            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Icon(category.iconData, color: category.accentColor, size: 32),
                  ),
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: GoogleFonts.sora(
                        ...
                        color: isDark ? category.accentColor : colorScheme.onSurface,
                      ),
                    ),
                  ),
                  IconButton(
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: GoogleFonts.inter(
                    fontSize: 13,
                    color: isDark ? category.accentColor.withOpacity(0.9) : colorScheme.onSurfaceVariant,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: category.accentColor.withOpacity(0.35),
                        blurRadius: 20,
                      ),
                    ],
                  ),
